...
int main(){
	...
	do{
		...
		printf("\nAhora debe ingresar los datos de la seccion\n");
			printf("Cual sera el numero del porcentaje asignado al primer corte de notas?: ");             					//Aquí se busca almacenar en la memoria el porcentaje que se desea calcular para la nota del corte 1 del estudiante. 
				scanf("%f", &porcentaje1);
